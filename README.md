...
I build small, local-first AI tools, mostly on macOS.

| Project | What it does |
|---|---|
| [ask-mac](https://github.com/birdindasky/ask-mac) | One Mac app, every LLM — chat, compare, make them debate, or force a consensus |
| [anima](https://github.com/birdindasky/anima) | Memory, moods, and a self-written diary for Claude Code — fully local |
